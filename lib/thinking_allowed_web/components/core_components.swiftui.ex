defmodule ThinkingAllowedWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `ThinkingAllowedWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ThinkingAllowedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ThinkingAllowedWeb.Gettext, "errors", msg, opts)
    end
  end
