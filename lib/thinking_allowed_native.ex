defmodule ThinkingAllowedNative do
  @moduledoc """
  ...
  import ThinkingAllowedWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([ThinkingAllowedWeb, CoreComponents, plugin.module_suffix])
