defmodule ThinkingAllowed.MixProject do
  use Mix.Project

  def project do
    [
      app: :thinking_allowed,
      version: "0.1.0",
      elixir: "~> 1.14",
  ...
  def application do
    [
      mod: {ThinkingAllowed.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind thinking_allowed", "esbuild thinking_allowed"],
      "assets.deploy": [
        "tailwind thinking_allowed --minify",
        "esbuild thinking_allowed --minify",
        "phx.digest"
      ]
    ]
  end
